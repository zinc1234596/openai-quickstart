...
class Model:
    def make_text_prompt(self, text: str, original_language: str, target_language: str) -> str:
        return f"从{original_language}翻译成{target_language}：{text}"
    ...
    def make_table_prompt(self, table: str, original_language: str, target_language: str) -> str:
        ...
        return f"从{original_language}翻译成{target_language}，以空格和换行符表示表格：\n{table}"

    def translate_prompt(self, content, original_language, target_language: str) -> str:
